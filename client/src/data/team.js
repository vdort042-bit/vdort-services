export const team = [
  ...
  },
  {
    ...
    bio: 'PhD in Machine Learning from Stanford, Dr. Meera leads VDORT\'s AI recruitment technology, building intelligent systems that match candidates with precision.',
    linkedin: '#',
  },
  {
    name: 'Robert Kim',
    designation: 'VP, Technology Solutions',
    bio: 'Robert oversees technology staffing across cloud, cybersecurity, and enterprise platforms. His deep technical background ensures quality talent matching.',
    linkedin: '#',
  },
  {
    name: 'Sneha Nair',
    designation: 'Head of Candidate Experience',
    bio: 'Sneha is passionate about career development. She leads the candidate services division, ensuring every professional gets personalized guidance and support.',
    linkedin: '#',
  },
];
...
export const coreValues = [
  {
    ...
    description: 'We create measurable value for clients and candidates through every interaction and placement.',
  },
  {
  ...
  },
  {
    ...
    description: 'Behind every resume is a person with aspirations. We treat every candidate with dignity and respect.',
  },
  {
    title: 'Excellence Driven',
    description: 'We hold ourselves to the highest standards, continuously raising the bar for quality and performance.',
  },
];
