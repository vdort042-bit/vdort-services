...
export default function AdminLogin() {
  ...
  // step: 'login' | 'forgot-email' | 'forgot-reset' | 'forgot-done'
    ...
    <div className="min-h-screen gradient-hero flex items-center justify-center relative overflow-hidden py-8 px-4">
      ...
      >
          ...
          {fpStep === 'login' && (
            <motion.div key="login" initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 30 }} transition={{ duration: 0.3 }}
              ...
              <div className="text-center mb-8">
                ...
                <h1 className="font-heading font-bold text-2xl text-white mb-1">Admin Portal</h1>
                <p className="text-surface-300 text-sm">Secure access to management dashboard</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4" autoComplete="off">
                ...
                <div className="relative">
                  ...
                  <input type="email" placeholder="admin@vdort.com" value={email} autoComplete="off"
          ...
          {fpStep === 'forgot-email' && (
            <motion.div key="forgot-email" initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -30 }} transition={{ duration: 0.3 }}
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-surface-300 text-sm">Enter your admin email to reset</p>
              </div>
              ...
              <form onSubmit={handleForgotEmail} className="space-y-4">
                <div className="relative">
                  <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-surface-300" />
                  <input type="email" placeholder="admin@vdort.com" value={fpEmail}
        ...
        <div className="text-center mt-5 flex flex-col sm:flex-row items-center justify-center gap-3 text-sm">
          ...
          <Link to="/client/login" className="text-surface-300/60 hover:text-surface-300 transition-colors text-xs">Client Portal</Link>
          <span className="hidden sm:block text-white/20">·</span>
